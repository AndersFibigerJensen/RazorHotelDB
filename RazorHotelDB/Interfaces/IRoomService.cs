...
namespace RazorHotelDB.Interfaces
{
    public interface IRoomService
    {
        ...
        /// <summary>
        /// sortere værelser på et specifikt hotel ud fra pris
        /// </summary>
        /// <param name="hotelnr"></param>
        /// <param name="price"></param>
        /// <returns> returnere en liste af hoteller hvor prisen enten er lig med eller under værdien i price </returns>
        Task<List<Room>> SortBypriceAsync(int hotelnr,int price);
